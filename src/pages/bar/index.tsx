...
export default function Stake() {
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Stake | Ave</title>
        <meta
          key="description"
          name="description"
        ...
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.avewsap.io/stake" />
        ...
        <meta
          ...
          content="Stake SUSHI in return for xSUSHI, an interest bearing and fungible ERC20 token designed to share revenue generated by all SUSHI products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.avewsap.io/xsushi-sign.png" />
        <meta key="og:title" property="og:title" content="STAKE SUSHI" />
        <meta key="og:url" property="og:url" content="https://app.avewsap.io/stake" />
        <meta key="og:image" property="og:image" content="https://app.avewsap.io/xsushi-sign.png" />
        <meta
          key="og:description"
      ...
      <div className="flex flex-col w-full min-h-full">
        <div className="flex justify-center mb-6">
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Maximize yield by staking AVE for xAVE`)}
              </div>
            ...
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as AVE proportional to your share of the AveClub. When your AVE is staked into the AveClub, you receive xAVE in return for voting rights and a fully composable token that can interact with other protocols. Your xAVE is continuously compounding, when you unstake you will receive all the originally deposited AVE and any additional from fees.`)}
            </div>
            {/* <div className="flex">
          ...
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image src="/xsushi-sign.png" alt="xAVE sign" width="100%" height="100%" layout="responsive" />
          </div>
        </div>
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between w-full h-24 max-w-xl p-4 rounded md:pl-5 md:pr-7 bg-light-yellow bg-opacity-40">
                <div className="flex flex-col">
                  ...
                  <div className="flex">
                    <a
                      href={`https://analytics.avewsap.io/bar`}
                      target="_blank"
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-dark-900 md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  <p className="font-bold text-large md:text-2xl text-high-emphesis">
                    {activeTab === 0 ? i18n._(t`Stake AVE`) : i18n._(t`Unstake`)}
                  </p>
                  <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
                    {`1 xAVE = ${xSushiPerSushi.toFixed(4)} AVE`}
                  </div>
                </div>
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex space-x-2 ">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}AVE`}
                      </p>
                    </div>
            ...
            <div className="flex flex-col w-full px-4 pt-6 pb-5 rounded bg-dark-900 md:px-8 md:pt-7 md:pb-9">
              <div className="flex flex-wrap">
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">xAVE</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">AVE</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col w-full mb-4 mt-7 md:mb-0">
                  ...
                  {account && (
                    <a
                      href={`https://analytics.avewsap.io/users/${account}`}
                      target="_blank"
                      rel="noreferrer noopener"
                      className={`
