  ...
  return (
    <Fragment>
      <Head>
        ...
        <meta name="application-name" content="AVE App" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="AVE App" />
        ...
        <meta key="twitter:title" name="twitter:title" content="AVE App" />
        <meta key="twitter:url" name="twitter:url" content="https://app.avewsap.io" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="Be a DeFi Chef with Sushi. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.avewsap.io/icons/icon-192x192.png" />
        <meta key="twitter:creator" name="twitter:creator" content="@Avewap" />
        <meta key="og:type" property="og:type" content="website" />
        <meta key="og:site_name" property="og:site_name" content="AVE App" />
        <meta key="og:url" property="og:url" content="https://app.avewsap.io" />
        <meta key="og:image" property="og:image" content="https://app.avewsap.io/apple-touch-icon.png" />
        <meta
          key="og:description"
