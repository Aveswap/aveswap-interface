...
import { ChainId, Currency, NATIVE, Percent, WNATIVE, WNATIVE_ADDRESS } from '@aveswapio/sdk'
...
export default function Remove() {
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | Ave</title>
        <meta key="description" name="description" content="Remove liquidity from the Aveswap AMM" />
      </Head>
          ...
          <div>
            ...
            <AutoColumn gap="md">
              ...
              <div>
                ...
                <AutoColumn justify="space-between" className="py-2.5 swap-arrow-wrapper">
                  <AutoRow justify={'flex-start'} style={{ padding: '0 1rem' }}>
                    <button className="z-10 -mt-0 -mb-0 rounded-full cursor-default bg-dark-900 p-3px">
