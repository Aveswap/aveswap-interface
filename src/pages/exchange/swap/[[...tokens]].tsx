...
export default function Swap() {
  ...
  return (
    <Container id="swap-page" className="py-4 md:py-8 lg:py-12">
      <Head>
        <title>{i18n._(t`Aveswap`)} | Ave</title>
        <meta
          key="description"
          name="description"
          content="Aveswap allows for swapping of ERC20 compatible tokens across multiple networks"
        />
      </Head>
      <TokenWarningModal
      ...
      />
      <DoubleGlowShadow>
        <div className="p-2 space-y-4 rounded bg-dark-900 z-1 swap-main-bg">
          <SwapHeader
