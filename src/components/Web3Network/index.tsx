...
function Web3Network(): JSX.Element | null {
  ...
  return (
    <Menu as="div" className="relative inline-block text-right hidden sm:inline-block">
      {({ open }) => (
        <>

          <div>
            <Menu.Button className="flex items-center rounded bg-dark-900 hover:bg-dark-800 whitespace-nowrap text-sm font-bold cursor-pointer select-none pointer-events-auto">
              <div className="grid items-center grid-flow-col px-3 py-2 space-x-2 text-sm rounded-lg pointer-events-auto auto-cols-max bg-dark-1000 text-secondary network-button">
                <Image src={NETWORK_ICON[chainId]} alt="Switch Network" className="rounded-md" width="22px" height="22px" />
                <div className="text-primary hidden xl:inline-block">{NETWORK_LABEL[chainId]}</div>
       ...
       {/*   <div
          ...
          >
            <Menu.Items className="absolute right-0 w-[max-content] mt-2 origin-top-right divide-y divide-dark-600 rounded shadow-lg bg-dark-900 z-50 ing-1 ring-black ring-opacity-5 focus:outline-none">
              <div>
                {[
                  ChainId.MAINNET,
                  // ChainId.MATIC,
